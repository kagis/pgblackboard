import { MaplibreglMap, LngLatBounds } from './maplibregl.js';
...
export default {
  ...
  methods: {
    ...
    on_map_click({ point }) {
      ...
      this.$store.select_rowcol(out_idx, row_idx);
