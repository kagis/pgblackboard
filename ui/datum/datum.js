...
export default {
  ...
  methods: {
    ...
    _get_curr_rowcol() {
      ...
      const { typeOid, att_name, att_notnull } = this.$store.out.frames[frame_idx]?.cols?.[col_idx] || 0;
      const updatable = Boolean(att_name);
      return { frame_idx, row_idx, col_idx, typeOid, updatable, att_notnull };
    },
    ...
    _watch_curr_rowcol({ frame_idx, row_idx, col_idx, updatable, typeOid, att_notnull }) {
